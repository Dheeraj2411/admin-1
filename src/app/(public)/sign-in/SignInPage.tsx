...
function SignInPage() {
  return (
    <div className='flex min-w-0 flex-1 flex-col items-center sm:flex-row sm:justify-center md:items-start md:justify-start'>
      <Paper className='h-full w-full px-16 py-8 ltr:border-r-1 rtl:border-l-1 sm:h-auto sm:w-auto sm:rounded-xl sm:p-48 sm:shadow md:flex md:h-full md:w-1/2 md:items-center md:justify-center md:rounded-none md:p-64 md:shadow-none'>
        <CardContent className='mx-auto w-full max-w-320 sm:mx-0 sm:w-320'>
          {/* <img className='w-78' src='/assets/images/logo/logo.svgss' alt='logo' /> */}
